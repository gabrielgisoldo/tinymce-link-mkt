tinymce.PluginManager.add('link-mkt', function(editor, url) {
    ...
    Text.prototype.makeTab = function(){
        return {
            name: 'tab_url_conf_texto',
            title: 'Texto',
            items: [
                {
                    type: 'input',
                    name: 'text',
                    label: 'Texto a exibir como link:'
                }
            ]
        }
    };
    ...
    var getDialog = function(tabs, init) {
        return {
            ...
            onSubmit: function(api){
                ...
                if(!anchor.checkURL()){
                    createAlert('error', 'Link: URL inválida.', 'warning')
                    throw 'Invalid URL'
                }
                ...
                if (data.type == 'txt'){
                    ...
                    if(!image.checkURL()){
                        createAlert('error', 'Imagem: URL inválida.', 'warning')
